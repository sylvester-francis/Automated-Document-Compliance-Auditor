...
def extract_document_text(file_path: str, file_content: bytes = None) -> str:
    ...
    def extract_from_pdf(
        ...
        try:
            ...
            try:
                ...
                # Add page-level data
                page_data = [
                    {"page_num": i + 1, "text_length": len(page_text)}
            ...
            return {"text": text, "metadata": metadata, "pages": page_data}
    ...
    def extract_from_docx(
        ...
        try:
            ...
            logger.warning(
                "python-docx not installed, falling back to simple extraction"
            )
            return {
    ...
    def extract_from_rtf(
        ...
        try:
            ...
            return {"text": text, "metadata": {"format": "rtf"}}
        except ImportError:
    ...
    def extract_from_xlsx(
        ...
        try:
            ...
            return {"text": text, "metadata": metadata, "sheet_data": sheet_data}
        except ImportError:
            # openpyxl not available
            return {
                "text": "Excel file cannot be processed (openpyxl library not installed)",
                "metadata": {"format": "xlsx", "error": "Missing dependency: openpyxl"},
            }
        except Exception as e:
    ...
    def extract_from_pptx(
        ...
        try:
            ...
            for i, slide in enumerate(prs.slides):
                ...
                text += slide_text + "\n"
                slides_data.append({"number": i + 1, "content": slide_content})
            ...
            return {"text": text, "metadata": metadata, "slides": slides_data}
        except ImportError:
    ...
    def extract_from_eml(
        ...
        try:
            ...
            return {"text": text, "metadata": {"format": "eml", "headers": headers}}
        except Exception as e:
            ...
            return {"text": content, "metadata": {"format": "eml", "error": str(e)}}
    ...
    def extract_from_json(
        ...
        try:
            ...
            return {"text": content, "metadata": {"format": "json", "error": str(e)}}
    ...
    def extract_from_xml(
        ...
        try:
            ...
            if file_content:
                tree = ET.ElementTree(
                    ET.fromstring(file_content.decode("utf-8", errors="ignore"))
                )
            else:
            ...
            return {"text": text, "metadata": metadata, "structure": xml_structure}
        except Exception as e:
            ...
            return {"text": content, "metadata": {"format": "xml", "error": str(e)}}
